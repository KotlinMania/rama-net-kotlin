...
This file is the quick-reference operating contract for rama-net-kotlin. The longer
...
rama-net-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rama-net`](https://crates.io/crates/rama-net). Upstream Rust is the behavioral oracle while the
