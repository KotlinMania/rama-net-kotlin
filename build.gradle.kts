...
kotlin {
    ...
    val xcf = XCFramework("RamaNet")

    // Apple desktop
    macosArm64 {
        binaries.framework { baseName = "RamaNet"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RamaNet"
        flattenPackage = "io.github.kotlinmania.ramanet"
    }

    android {
        namespace = "io.github.kotlinmania.ramanet"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rama-net-kotlin", version.toString())

    pom {
        name.set("rama-net-kotlin")
        description.set("Kotlin Multiplatform port of plabayo/rama - rama network types and utilities")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rama-net-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rama-net-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rama-net-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rama-net-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    val emptySourceSentinel = layout.buildDirectory.file(
        "generated/sources/codeql-empty-source-sentinel/kotlin/io/github/kotlinmania/ramanet/CodeqlEmptySourceSentinel.kt",
    )
    ...
    doFirst {
        ...
        val sourceFiles = sources.files.sortedBy { it.relativeTo(projectDir).invariantSeparatorsPath }
        val compileSources = if (sourceFiles.isEmpty()) {
